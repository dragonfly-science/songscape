...
urlpatterns = patterns(
    ...
    url(r'^media/sonograms/(?P<path>.*)$', 'django.views.static.serve', {'document_root': os.path.join(settings.SONOGRAM_DIR)}, name='sonogram-media'),
    url(r'^media/snippets/(?P<path>.*)$', 'django.views.static.serve', {'document_root': os.path.join(settings.SNIPPET_DIR)}, name='snippet-media'),
