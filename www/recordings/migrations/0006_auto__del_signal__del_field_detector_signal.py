...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'recordings_signal')

        # Deleting field 'Detector.signal'
        db.delete_column(u'recordings_detector', 'signal_id')


    def backwards(self, orm):
        # Adding model 'Signal'
        db.create_table(u'recordings_signal', (
            ('code', self.gf('django.db.models.fields.SlugField')(max_length=64, unique=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'recordings', ['Signal'])

        # Adding field 'Detector.signal'
        db.add_column(u'recordings_detector', 'signal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='detectors', to=orm['recordings.Signal']),
                      keep_default=False)
