...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Analysis', fields ['code']
        db.create_unique(u'recordings_analysis', ['code'])

        # Adding field 'Identification.datetime'
        db.add_column(u'recordings_identification', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 23, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Analysis', fields ['code']
        db.delete_unique(u'recordings_analysis', ['code'])

        # Deleting field 'Identification.datetime'
        db.delete_column(u'recordings_identification', 'datetime')
