...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SonogramTransform'
        db.create_table(u'recordings_sonogramtransform', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('min_freq', self.gf('django.db.models.fields.FloatField')()),
            ('max_freq', self.gf('django.db.models.fields.FloatField')()),
            ('duration', self.gf('django.db.models.fields.FloatField')()),
            ('top_px', self.gf('django.db.models.fields.FloatField')()),
            ('bottom_px', self.gf('django.db.models.fields.FloatField')()),
            ('left_px', self.gf('django.db.models.fields.FloatField')()),
            ('right_px', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'recordings', ['SonogramTransform'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SonogramTransform'
        db.delete_table(u'recordings_sonogramtransform')
    ...
    models = {
        ...
        u'recordings.sonogramtransform': {
            'Meta': {'unique_together': "(('min_freq', 'max_freq', 'duration', 'top_px', 'bottom_px', 'left_px', 'right_px'),)", 'object_name': 'SonogramTransform'},
