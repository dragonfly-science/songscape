...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CallLabel'
        db.create_table(u'recordings_calllabel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.TextField')(unique=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='call_labels', to=orm['auth.User'])),
            ('analysisset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='call_labels', to=orm['recordings.AnalysisSet'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='call_labels', to=orm['recordings.Tag'])),
            ('start_time', self.gf('django.db.models.fields.FloatField')()),
            ('end_time', self.gf('django.db.models.fields.FloatField')()),
            ('low_frequency', self.gf('django.db.models.fields.FloatField')()),
            ('high_frequency', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'recordings', ['CallLabel'])

        # Adding M2M table for field tag_set on 'CallLabel'
        m2m_table_name = db.shorten_name(u'recordings_calllabel_tag_set')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('calllabel', models.ForeignKey(orm[u'recordings.calllabel'], null=False)),
            ('tag', models.ForeignKey(orm[u'recordings.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['calllabel_id', 'tag_id'])
    ...
    models = {
        ...
        u'recordings.calllabel': {
            'Meta': {'object_name': 'CallLabel'},
            'analysisset': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'call_labels'", 'to': u"orm['recordings.AnalysisSet']"}),
            'code': ('django.db.models.fields.TextField', [], {'unique': 'True'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.FloatField', [], {}),
            'high_frequency': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'low_frequency': ('django.db.models.fields.FloatField', [], {}),
            'start_time': ('django.db.models.fields.FloatField', [], {}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'call_labels'", 'to': u"orm['recordings.Tag']"}),
            'tag_set': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['recordings.Tag']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'call_labels'", 'to': u"orm['auth.User']"})
        },
        ...
        u'recordings.sonogram': {
            'Meta': {'object_name': 'Sonogram'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'path': ('django.db.models.fields.TextField', [], {}),
            'snippet': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['recordings.Snippet']"}),
            'transform': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['recordings.SonogramTransform']"})
        },
        u'recordings.sonogramtransform': {
            'Meta': {'object_name': 'SonogramTransform'},
            'bottom_px': ('django.db.models.fields.FloatField', [], {}),
            'dpi': ('django.db.models.fields.FloatField', [], {}),
            'duration': ('django.db.models.fields.FloatField', [], {}),
            'framerate': ('django.db.models.fields.FloatField', [], {}),
            'height': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'left_px': ('django.db.models.fields.FloatField', [], {}),
            'max_freq': ('django.db.models.fields.FloatField', [], {}),
            'min_freq': ('django.db.models.fields.FloatField', [], {}),
            'n_fft': ('django.db.models.fields.FloatField', [], {}),
            'right_px': ('django.db.models.fields.FloatField', [], {}),
            'top_px': ('django.db.models.fields.FloatField', [], {}),
