...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Identification.snippet'
        db.delete_column(u'recordings_identification', 'snippet_id')

        # Deleting field 'Identification.analysis'
        db.delete_column(u'recordings_identification', 'analysis_id')


    def backwards(self, orm):
        # Adding field 'Identification.snippet'
        db.add_column(u'recordings_identification', 'snippet',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='identifications', to=orm['recordings.Snippet']),
                      keep_default=False)

        # Adding field 'Identification.analysis'
        db.add_column(u'recordings_identification', 'analysis',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='identifications', to=orm['recordings.Analysis']),
                      keep_default=False)
