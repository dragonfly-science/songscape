...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deployment.recorder'
        db.alter_column(u'recordings_deployment', 'recorder_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['recordings.Recorder']))

    def backwards(self, orm):

        # Changing field 'Deployment.recorder'
        db.alter_column(u'recordings_deployment', 'recorder_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['recordings.Recorder']))
    ...
    models = {
        ...
        u'recordings.deployment': {
            ...
            'recorder': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'deployments'", 'null': 'True', 'to': u"orm['recordings.Recorder']"}),
