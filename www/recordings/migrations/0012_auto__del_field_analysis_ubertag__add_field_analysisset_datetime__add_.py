...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Analysis.ubertag'
        db.delete_column(u'recordings_analysis', 'ubertag_id')

        # Adding field 'AnalysisSet.datetime'
        db.add_column(u'recordings_analysisset', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 1, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Tag.datetime'
        db.add_column(u'recordings_tag', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 1, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Analysis.ubertag'
        db.add_column(u'recordings_analysis', 'ubertag',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ubertags', null=True, to=orm['recordings.Tag'], blank=True),
                      keep_default=False)

        # Deleting field 'AnalysisSet.datetime'
        db.delete_column(u'recordings_analysisset', 'datetime')

        # Deleting field 'Tag.datetime'
        db.delete_column(u'recordings_tag', 'datetime')
