...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AnalysisSet', fields ['snippet', 'analysis']
        db.create_unique(u'recordings_analysisset', ['snippet_id', 'analysis_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AnalysisSet', fields ['snippet', 'analysis']
        db.delete_unique(u'recordings_analysisset', ['snippet_id', 'analysis_id'])
