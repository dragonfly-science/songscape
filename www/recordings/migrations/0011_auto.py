...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field fans on 'Snippet'
        db.create_table(u'recordings_snippet_fans', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('snippet', models.ForeignKey(orm[u'recordings.snippet'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'recordings_snippet_fans', ['snippet_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field fans on 'Snippet'
        db.delete_table('recordings_snippet_fans')
    ...
    models = {
        ...
        u'recordings.snippet': {
            ...
            'duration': ('django.db.models.fields.FloatField', [], {}),
            'fans': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'favourites'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
