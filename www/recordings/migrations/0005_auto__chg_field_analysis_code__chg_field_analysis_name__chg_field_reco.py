...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Analysis.code'
        db.alter_column(u'recordings_analysis', 'code', self.gf('django.db.models.fields.SlugField')(max_length=64))

        # Changing field 'Analysis.name'
        db.alter_column(u'recordings_analysis', 'name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Recorder.code'
        db.alter_column(u'recordings_recorder', 'code', self.gf('django.db.models.fields.SlugField')(max_length=64))

        # Changing field 'Detector.code'
        db.alter_column(u'recordings_detector', 'code', self.gf('django.db.models.fields.SlugField')(max_length=64))

        # Changing field 'Tag.code'
        db.alter_column(u'recordings_tag', 'code', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=64))

        # Changing field 'Tag.name'
        db.alter_column(u'recordings_tag', 'name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Site.code'
        db.alter_column(u'recordings_site', 'code', self.gf('django.db.models.fields.SlugField')(max_length=64))

        # Changing field 'Signal.code'
        db.alter_column(u'recordings_signal', 'code', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=64))

        # Changing field 'Organisation.code'
        db.alter_column(u'recordings_organisation', 'code', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=64))

    def backwards(self, orm):

        # Changing field 'Analysis.code'
        db.alter_column(u'recordings_analysis', 'code', self.gf('django.db.models.fields.SlugField')(max_length=32))

        # Changing field 'Analysis.name'
        db.alter_column(u'recordings_analysis', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
        ...
        # Changing field 'Tag.code'
        db.alter_column(u'recordings_tag', 'code', self.gf('django.db.models.fields.SlugField')(max_length=32, unique=True))
        ...
        # Changing field 'Signal.code'
        db.alter_column(u'recordings_signal', 'code', self.gf('django.db.models.fields.SlugField')(max_length=32, unique=True))

        # Changing field 'Organisation.code'
        db.alter_column(u'recordings_organisation', 'code', self.gf('django.db.models.fields.SlugField')(max_length=32, unique=True))
