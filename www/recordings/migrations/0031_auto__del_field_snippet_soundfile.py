...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Snippet.soundfile'
        db.delete_column(u'recordings_snippet', 'soundfile')


    def backwards(self, orm):
        # Adding field 'Snippet.soundfile'
        db.add_column(u'recordings_snippet', 'soundfile',
