...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('recordings_identification_true_tags', 'recordings_identification_tags')

    def backwards(self, orm):
        db.rename_table('recordings_identification_tags', 'recordings_identification_true_tags')
