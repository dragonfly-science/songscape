...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Recording.sha1'
        db.delete_column(u'recordings_recording', 'sha1')

        # Adding field 'Recording.md5'
        db.add_column(u'recordings_recording', 'md5',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Recording.sha1'
        db.add_column(u'recordings_recording', 'sha1',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)

        # Deleting field 'Recording.md5'
        db.delete_column(u'recordings_recording', 'md5')
