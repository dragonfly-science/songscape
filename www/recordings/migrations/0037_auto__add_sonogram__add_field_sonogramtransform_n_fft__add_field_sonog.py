...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SonogramTransform', fields ['min_freq', 'max_freq', 'duration', 'top_px', 'bottom_px', 'left_px', 'right_px']
        db.delete_unique(u'recordings_sonogramtransform', ['min_freq', 'max_freq', 'duration', 'top_px', 'bottom_px', 'left_px', 'right_px'])

        # Adding model 'Sonogram'
        db.create_table(u'recordings_sonogram', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('snippet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recordings.Snippet'])),
            ('transform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recordings.SonogramTransform'])),
            ('path', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'recordings', ['Sonogram'])

        # Adding field 'SonogramTransform.n_fft'
        db.add_column(u'recordings_sonogramtransform', 'n_fft',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

        # Adding field 'SonogramTransform.framerate'
        db.add_column(u'recordings_sonogramtransform', 'framerate',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Sonogram'
        db.delete_table(u'recordings_sonogram')

        # Deleting field 'SonogramTransform.n_fft'
        db.delete_column(u'recordings_sonogramtransform', 'n_fft')

        # Deleting field 'SonogramTransform.framerate'
        db.delete_column(u'recordings_sonogramtransform', 'framerate')

        # Adding unique constraint on 'SonogramTransform', fields ['min_freq', 'max_freq', 'duration', 'top_px', 'bottom_px', 'left_px', 'right_px']
        db.create_unique(u'recordings_sonogramtransform', ['min_freq', 'max_freq', 'duration', 'top_px', 'bottom_px', 'left_px', 'right_px'])
