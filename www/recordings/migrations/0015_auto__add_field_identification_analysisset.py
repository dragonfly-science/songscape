...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Identification.analysisset'
        db.add_column(u'recordings_identification', 'analysisset',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='identifications', to=orm['recordings.AnalysisSet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Identification.analysisset'
        db.delete_column(u'recordings_identification', 'analysisset_id')
