...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            risto = orm['auth.User'].objects.get(username='risto')
            orm.Identification.objects.filter(user=risto).delete()
        except (orm['auth.User'].DoesNotExist, orm.Identification.DoesNotExist):
            pass

    def backwards(self, orm):
        "Write your backwards methods here."
        raise RuntimeError, "No going back."
