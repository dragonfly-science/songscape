...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SonogramTransform.width'
        db.add_column(u'recordings_sonogramtransform', 'width',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

        # Adding field 'SonogramTransform.height'
        db.add_column(u'recordings_sonogramtransform', 'height',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

        # Adding field 'SonogramTransform.dpi'
        db.add_column(u'recordings_sonogramtransform', 'dpi',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SonogramTransform.width'
        db.delete_column(u'recordings_sonogramtransform', 'width')

        # Deleting field 'SonogramTransform.height'
        db.delete_column(u'recordings_sonogramtransform', 'height')

        # Deleting field 'SonogramTransform.dpi'
        db.delete_column(u'recordings_sonogramtransform', 'dpi')
