...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for i in orm.Identification.objects.all():
            aset = orm.AnalysisSet.objects.filter(snippet=i.analysisset.snippet, analysis=i.analysisset.analysis)
            dups = orm.AnalysisSet.objects.filter(snippet=i.analysisset.snippet, 
