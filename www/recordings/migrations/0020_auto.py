...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tag_set on 'Identification'
        db.create_table(u'recordings_identification_tag_set', (
        ...
        db.create_unique(u'recordings_identification_tag_set', ['identification_id', 'tag_id'])


    def backwards(self, orm):
        # Removing M2M table for field tag_set on 'Identification'
        db.delete_table('recordings_identification_tag_set')
