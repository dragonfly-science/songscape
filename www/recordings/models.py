...
class Site(models.Model):
    ...
    north_densiometer = models.FloatField(null=True, blank=True)
    south_densiometer = models.FloatField(null=True, blank=True)
    east_densiometer = models.FloatField(null=True, blank=True)
    west_densiometer = models.FloatField(null=True, blank=True)
    habitat = models.TextField(null=True, blank=True)
    vegetation = models.TextField(null=True, blank=True)
    pet = models.TextField(null=True, blank=True)
    contacts = models.TextField(null=True, blank=True)
    directions = models.TextField(null=True, blank=True)
    address = models.TextField(null=True, blank=True)
    compost = models.TextField(null=True, blank=True)
    site_change_2015 = models.TextField(null=True, blank=True)
    changes_2015 = models.TextField(null=True, blank=True)
